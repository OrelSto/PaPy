...
#             chronicle_writing=True)
# cpa.out.pie_output(target_species=['O2','O3','O'],act_P_json='ActP_Lehmann2004_P4del.json',del_P_json='DelP_Lehmann2004_P4del.json',chem_R_json='ChemS_Lehmann2004_P4del.json')
...
#             chronicle_writing=True)
# cpa.out.pie_output(target_species=['O2','O[3p]','CH4','CH3','CH3CHO','H2O','C2H4','HCO','[3]CH2'],act_P_json='ActP_Uranus.json',del_P_json='DelP_Uranus.json',chem_R_json='ChemS_Uranus.json')
