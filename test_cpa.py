...
# cpa.run_cpa(timestep=1.0,rate_threshold=1.0e-18,t_min=1.0e14,target_species=['O2','O(3P)','CH4','CH3CHO','H2O','C2H4','HCO'],filename_model='reactions_Uranus.txt',filename_concentration='concentrations_Uranus.txt',chronicle_writing=True)
