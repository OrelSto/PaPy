...
# cpa.run_cpa(timestep=1.0,rate_threshold=0.3e-9,t_min=1.0e4,target_specie='O3',filename_model='user_model_example.txt',filename_concentration='user_concentration_example.txt',chronicle_writing=True)
