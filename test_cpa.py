...
# cpa.run_cpa(timestep=100.0,rate_threshold=1e-12,t_min=1.0e4,target_specie='None',filename_model='user_model_example.txt',filename_concentration='user_concentration_example.txt',chronicle_writing=True)

# test article to see if P4 is deleted!
cpa.run_cpa(timestep=1.0,rate_threshold=0.3e-9,t_min=1.0e4,target_specie='None',filename_model='user_model_example.txt',filename_concentration='user_concentration_example.txt',chronicle_writing=True)
